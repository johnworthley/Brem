...
contract('BREMICO', function(accounts) {
    ...
    beforeEach(async function() {
        ...
        this.brem = await BREM.new(this.brm.address, this.icoCreationPrice, this.withdrawFeePercent, {from:superuser});
    ...
    context('parameters were initialized correctly', () => {
        ...
        it('docHash', async function () {
            ...
            assert.equal(web3.toAscii(res), this.bdocHash);
        });
    ...
    context('addAuditor', () => {
        ...
        it('does not allow the superuser to add a local Auditor, if the Auditor does not exist globally', async function () {
            ...
            await assertRevert(
                this.bremIco.addAuditor(auditor1)
            );
        ...
        it('does not allow anyone to add a local Auditor', async function () {
            ...
            await assertRevert(
                this.bremIco.addAuditor(auditor1, {from:dev})
            );

            await assertRevert(
                this.bremIco.addAuditor(auditor1, {from:anyone})
            );
    ...
    context('finishAuditorSelection', () => {
        ...
        it('does not allow anyone to finishAuditorSelection', async function () {
            ...
            await assertRevert(
                this.bremIco.finishAuditorSelection({from:dev})
            );
            await assertRevert(
                this.bremIco.finishAuditorSelection({from:anyone})
            );
    ...
    context('withdraw', () => {
        ...
        it('does not allow the superuser to withdraw', async function () {
            ...
            await this.bremIco.buyTokens(anyone, {from:anyone, value: this.bcap*2});
            
            await increaseTimeTo(this.bclosingTime + 3600);


            await assertRevert(
                this.bremIco.withdraw(this.bcap, {from:superuser})
            );
        ...
        it('does not allow anyone to withdraw', async function () {
            ...
            await assertRevert(
                this.bremIco.withdraw(this.bcap, {from:anyone})
            );
        ...
        it('does not allow creation of a new withdrawal, if the decision on the previous one was not made', async function () {
            ...
            await this.bremIco.buyTokens(anyone, {from:anyone, value: this.bcap*3});
    ...
    context('confirmWithdraw', () => {
        it('works with 1 auditor', async function () {
            ...
            assert.equal(res, this.bcap - ((this.bcap/100)*this.withdrawFeePercent)); 
        ...
        it('does not allow 1 auditor confirmWithdraw second time', async function () {
            ...
            await assertRevert(
                this.bremIco.confirmWithdraw({from:auditor1})
            );
        ...
        it('does not allow anyone to confirmWithdraw', async function () {
            ...
            await assertRevert(
                this.bremIco.confirmWithdraw({from:anyone})
            );

            await assertRevert(
                this.bremIco.confirmWithdraw({from:superuser})
            );
    ...
    context('confirmWithdraw', () => {
        it('allows the user with non-zero balance to refund if the cap has not been reached', async function () {
            ...
            await this.bremIco.buyTokens(anyone, {from:anyone, value: this.bcap/4, gasPrice: 0});
            await this.bremIco.buyTokens(anyone2, {from:anyone2, value: this.bcap/4});
            await increaseTimeTo(this.bclosingTime + 3600);
        ...
        it('does not allow confirmWithdraw if capReached', async function () {
            ...
            await assertRevert(
                this.bremIco.refund({from:anyone})
            );
        ...
        it('does not allow confirmWithdraw during the ico', async function () {
            ...
            await this.bremIco.buyTokens(anyone, {from:anyone, value: this.bcap/4});
            await this.bremIco.buyTokens(anyone2, {from:anyone2, value: this.bcap/4});
    ...
    context('buyTokens', () => {
        it('allow anyone buyTokens', async function () {
            ...
            await this.bremIco.buyTokens(anyone, {from:anyone, value: purchaseAmount});
            await this.bremIco.buyTokens(anyone2, {from:anyone2, value: this.bcap/4});
